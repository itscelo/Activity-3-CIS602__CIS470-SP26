...
describe('classifyTriangle: Required input conditions', () => {
    ...
    test('ECP: Invalid Input (negative value)', () => expect(classifyTriangle(-1, 10, 10)).toBe('Error: Input conditions C1, C2, or C3 failed.'));
    test('ECP: Not a Triangle (a+b<c)', () => expect(classifyTriangle(2, 2, 5)).toBe('Not a Triangle'));
});
